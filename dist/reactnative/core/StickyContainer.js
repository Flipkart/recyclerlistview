...
var StickyContainer = /** @class */ (function(_super) {
  ...
  StickyContainer.prototype.render = function() {
    ...
    var recycler = React.cloneElement(this.props.children, __assign({}, this.props.children.props, {
    ...
    return (React.createElement(react_native_1.View, {style: this.props.style ? this.props.style : {flex: 1}},
      recycler,
      this.props.stickyHeaderIndices ? (React.createElement(StickyHeader_1.default, {
        ref: function(stickyHeaderRef) {
      ...
      this.props.stickyFooterIndices ? (React.createElement(StickyFooter_1.default, {
        ref: function(stickyFooterRef) {
